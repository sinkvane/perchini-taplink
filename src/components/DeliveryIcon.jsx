...
const DeliveryIcon = ({ className }) => (
  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      ...
      <path d="M19.1,16.8c0.4-0.1,0.7-0.1,1.1-0.2c1.3-0.1,2.8-0.8,4.3-2.3l4.9-4.9"/>
      <path d="M12.3,19.3L5.3,25c-1.1,0.8-1.2,2.4-0.2,3.3c1,1,2.5,0.8,3.3-0.2l5.7-7.1"/>
      <path d="M24,4L19,8.9c-1.5,1.5-2.3,3-2.3,4.3c0,0.4-0.1,0.7-0.2,1.1"/>
    </g>
  </svg>
);
